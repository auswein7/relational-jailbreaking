# phase5_pilot: model conformance

```
llama31_8b_128k: conforms
  ...
  passed  ainvoke_returns_assistant_message: 8 chars of content
  ...
  passed  usage_reporting: usage surfaced on the reply (prompt_tokens=28, completion_tokens=2, done_reason=stop)
  ...
  passed  ainvoke_cooperates_with_the_loop: 31 ms, 5 loop tick(s) during the call
...
judge: conforms
  ...
  passed  ainvoke_cooperates_with_the_loop: 39 ms, 7 loop tick(s) during the call
```
